...
export function ProfilScreen({ setNavSelectionne }) {
    ...
    return (
        <View style={{ alignItems: 'center', justifyContent: 'center', flex: 1}}>
            ...
            <Text style={{fontFamily: "Montserrat-Medium", marginTop: 20, marginHorizontal: 40}}>Pour démarrer le jeu, direction l'onglet 'Cards' situé en bas à gauche, et amusez-vous à swiper quelques cartes.</Text>
